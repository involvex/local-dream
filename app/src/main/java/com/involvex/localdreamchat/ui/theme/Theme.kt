package com.involvex.localdreamchat.ui.theme
...
import com.involvex.localdreamchat.data.ThemePreferences
import com.involvex.localdreamchat.data.ThemeState
...
@Composable
fun LocalDreamTheme(themeState: ThemeState, content: @Composable () -> Unit) {
